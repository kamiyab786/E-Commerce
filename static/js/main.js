...
(function($) {
    ...
    $('.inc').click(function() {
        ...
        var price = this.parentNode.parentNode.parentNode.parentNode.children[4].children[1]
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                price.innerHTML = data.quantity * data.product_price
    ...
    $('.rmv').click(function() {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                document.getElementById('amount').innerHTML = data.amount
                document.getElementById('total_amount').innerHTML = data.total_amount
                thisvar.parentNode.parentNode.remove()
                product_count.innerHTML = data.product_count
            }
        })
    })

    $('.rmv_address').click(function() {
        var id = $(this).attr("add_id").toString();
        var thisvar = this
        $.ajax({
            type: "GET",
            url: "/remove_address",
            ...
            success: function(data) {
                ...
                thisvar.parentNode.parentNode.parentNode.remove()
            }
        })
    })
